...
function sendCommonMail() {
    $sendcloud = new \sendcloud\SendCloud("***", "***", 'v1');
    $mail = new \sendcloud\util\Mail();
...
function sendCommonMail_v2() {
    ...
    $sendcloud = new \sendcloud\SendCloud("***", "***", 'v2');
    $mail = new \sendcloud\util\Mail();
    $mail->addBcc("lianzimi@ifaxin.com");
    $mail->addCc("bida@ifaxin.com");
    $mail->setFrom("test@test.com");
...
function sendTemplateMail() {
    ...
    $templateContent = new \sendcloud\util\TemplateContent();
...
function sendTemplateMailWithAddressAndAttachment() {
    ...
    $filetype = \sendcloud\util\Mimetypes::getInstance()->fromFilename($file);
    ...
    $filetype2 = \sendcloud\util\Mimetypes::getInstance()->fromFilename($file2);
    ...
    $filetype3 = \sendcloud\util\Mimetypes::getInstance()->fromFilename($file3);
    $file4 = "C:\\test_email\\test.doc";
    $handle4 = fopen($file4, 'rb');
    $content4 = fread($handle4, filesize($file4));
    $filetype4 = \sendcloud\util\Mimetypes::getInstance()->fromFilename($file4);

    $attachment = new \sendcloud\util\Attachment();
